...
@mcp.tool()
async def get_daily_cardiovascular_age(start_date: str, end_date: str) -> dict[str, Any]:
...
@mcp.tool()
async def get_multiple_daily_readiness(start_date: str, end_date: str) -> dict[str, Any]:
...
@mcp.tool()
async def get_multiple_daily_resilience(start_date: str, end_date: str) -> dict[str, Any]:
...
@mcp.tool()
async def get_multiple_daily_heart_rate(start_date: str, end_date: str) -> dict[str, Any]:
